...
export interface Trade {
  ...
  tp: number | null
  exit: number | null
  /** سود/زیان خالص واقعی (به دلار، شاملِ کمیسیون و سواپ) برای معاملات وارد‌شده از متاتریدر؛ ثبت دستی null.
   *  R نهایی = این سودِ خالص ÷ ریسکِ واقعی. */
  profit: number | null
  /** کمیسیونِ معامله (دلار، معمولاً منفی) — از گزارش متاتریدر؛ null اگر نامشخص. */
  commission: number | null
  /** سواپِ معامله (دلار) — از گزارش متاتریدر؛ null اگر نامشخص. */
  swap: number | null
